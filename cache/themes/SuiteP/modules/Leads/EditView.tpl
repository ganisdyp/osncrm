...
{/if}  
<input type='text' name='{$fields.nickname_c.name}' 
id='{$fields.nickname_c.name}' size='30' 
maxlength='100' 
value='{$value}' title=''      >
</div>
...
<span class="dateTime">
{assign var=date_value value=$fields.date_applied_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_applied_c.name}" id="{$fields.date_applied_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="{$fields.date_applied_c.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.date_applied_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.date_applied_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
startWeekday: {$CALENDAR_FDOW|default:'0'},
step : 1,
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.date_renewed_c.name}" id="{$fields.date_renewed_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
...
<input class="date_input" autocomplete="off" type="text" name="{$fields.membership_expired_c.name}" id="{$fields.membership_expired_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
...
addToValidate('EditView', 'amway_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AMWAY_ID' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_applied_c', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_APPLIED' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'date_renewed_c', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_RENEWED' module='Leads' for_js=true}{literal}' );
...
addToValidate('EditView', 'membership_expired_c', 'date', false,'{/literal}{sugar_translate label='LBL_MEMBERSHIP_EXPIRED' module='Leads' for_js=true}{literal}' );
addToValidate('EditView', 'nickname_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_NICKNAME' module='Leads' for_js=true}{literal}' );
